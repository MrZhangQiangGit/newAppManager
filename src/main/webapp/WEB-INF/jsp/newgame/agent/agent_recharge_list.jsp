						...
						<div class="am-panel am-panel-secondary am-text-sm am-margin-bottom-sm">
						  ...
						  <div class="am-panel-bd am-text-xs">
						  	<ul class="am-avg-sm-3">
						  		...
						  		<li>
							    	<div class="">
							    		<c:if test="${var.CHARGE_TYPE=='1' }"><i class="am-badge am-badge-danger am-round">购买</i></c:if>
							    		<c:if test="${var.CHARGE_TYPE=='2' }"><i class="am-badge am-badge-primary am-round">赠送</i></c:if>
							    		<c:if test="${var.CHARGE_TYPE=='3' }"><i class="am-badge am-badge-secondary am-round">赔偿</i></c:if>
							    		<c:if test="${var.CHARGE_TYPE=='4' }"><i class="am-badge am-badge-success am-round">奖励</i></c:if>
							    	</div>
						  		</li>
						  	</ul>
						  </div>
...
<script type="text/javascript">
	...
	function loadMore(page,keywords){
		...
		//ajax添加
		$.ajax({
			url:"agentRechargeApp/loadMoreARList.do",
	...
	function search(){
		...
		var url = "agentRechargeApp/agentRechargeList.do?keywords="+keywords;
