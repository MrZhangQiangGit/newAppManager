				...
				window.onload=function(){
					$.ajax({
						...
						"success":function(data){
							...
							if(data[0].AGENT_CODE != 888888){
								$("#sheng").text("剩余钻石 : "+data[0].CARD_NUM+" 颗");
								$("#sale").text("出售总额 : "+data[0].SALE_TOTAL+" 颗");
							}
						}
					});
				}
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						<li title="剩余钻石" class="grey">
							<span id="sc"><span id="sheng"></span></span>
						</li>
						<li title="出售总量" class="grey">
							<span id="sl"><span id="sale"></span></span>
						</li>
