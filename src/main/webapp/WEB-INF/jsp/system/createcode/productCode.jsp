...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<input type="hidden"  id="ctype" value="${pd.FHTYPE}">
						<div id="zhongxin">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:com.bets.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td style="width:76px;text-align: right;">表名称：</td>
								<td><input type="text" name="tabletop" id="tabletop" value="${msg == 'add' ? 'TB_' : ''}${fn:split(pd.TABLENAME, ',fh,')[0]}" placeholder="这里输入表名称" style="width:156px" title="表前缀"/></td>
							</tr>
						</table>
						...
						<h4 class="lighter block green"><strong id="second_show">10秒</strong></h4>
						</div>
...
<!-- /.main-container -->	
		...
		function reductionFields(){
			...
			if('edit' == msg){
				...
				var fieldarray = nowarField.split('Qbets');
