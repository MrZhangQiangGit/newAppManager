				...
				<div class="row">
					...
					<form action="agentrecharge/${msg}.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:90px;text-align: right;padding-top: 13px;">退卡数:</td>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function checks(value){
			var id = ${num};
			var aid=$("#AGENTRECHARGE_ID").val();//充值记录id
				$.ajax({
					"url":"agentrecharge/findObjectByid.do",
					"data":{"id":id,"aid":aid},
					"type":"GET",
					"dataType":"json",
					"async":"true",
					"success":function(data){
						...
						if(data[0].CHARGE_NUM<parseInt(value)){
							$("#CHARGE_NUM").tips({
								side:3,
					            msg:'不能超过充卡数',
					            bg:'#AE81FF',
