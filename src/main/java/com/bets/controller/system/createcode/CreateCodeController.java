package com.bets.controller.system.createcode;
...
import com.bets.service.system.createcode.CreateCodeManager;
import com.bets.util.AppUtil;
import com.bets.util.DateUtil;
import com.bets.util.DelAllFile;
import com.bets.util.FileDownload;
import com.bets.util.FileZip;
import com.bets.util.Freemarker;
import com.bets.util.Jurisdiction;
import com.bets.util.PageData;
import com.bets.util.PathUtil;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		Freemarker.printFile("sqlserver_SQL_Template.ftl", root, "sqlserver数据库脚本/"+objectName.toUpperCase()+".sql", filePath, ftlPath);
		/*生成jsp页面*/
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop"));	//表名
