...
/*    public boolean sendMail(String title,String content,String type,String tomail) throws Exception{   
    ...
    public static void main(String[] args) throws Exception{   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("zhangjie3150@163.com");    
	     mailInfo.setPassword("zj19840624");//您的邮箱密码    
	     mailInfo.setFromAddress("zhangjie3150@163.com");   
	     mailInfo.setToAddress("381041209@qq.com");    
