...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = "admin/config/NO_INTERCEPTOR_PATH.txt";	//不对匹配该值的访问路径拦截（正则）
	public static ApplicationContext WEB_APP_CONTEXT = null; //该值会在web容器启动时由WebAppContextListener初始化
	
	public static final String NOTICE_PATH = "admin/config/NOTICE.txt";//修改公告清理缓存配置路径
