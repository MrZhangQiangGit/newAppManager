package com.bets.dao.redis.impl;
...
import com.bets.dao.AbstractBaseRedisDao;
import com.bets.dao.redis.RedisDao;
import com.bets.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.bets.dao.redis.RedisDao#delete(java.lang.String)
	 */
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.bets.dao.redis.RedisDao#delete(java.util.List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.bets.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.bets.dao.redis.RedisDao#get(java.lang.String)
	 */
	@Override
