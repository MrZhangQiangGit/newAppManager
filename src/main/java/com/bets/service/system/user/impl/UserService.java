package com.bets.service.system.user.impl;
...
public class UserService implements UserManager{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<PageData> listAgent(PageData pd)throws Exception{
		return (List<PageData>) dao.findForList("UserMapper.listAgent", pd);
	}
