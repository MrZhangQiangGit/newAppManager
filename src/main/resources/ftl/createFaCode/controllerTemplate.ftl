package com.bets.controller.${packageName}.${objectNameLower};
...
import com.bets.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.bets.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
